...
class Playlist extends React.Component {
    ...
    trackOnClick(e, trackData) {
        ...
        let { dispatch, playlist, currentTab } = this.props;
    ...
    trackListOnScrolled(e, cb) {
        let { dispatch } = this.props,
            { searchText } = this.props.playlist;
    ...
    tabOnChanged(tabName) {
        let { dispatch, favorites } = this.props;
    ...
    render() {
        let { playlist, currentTab, favorites } = this.props,
            fetching = currentTab === 'playlist' ? playlist.fetching : favorites.fetching;
