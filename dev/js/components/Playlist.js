...
class Playlist extends React.Component {
    ...
    tabOnChanged(e) {
        let tabOnChanged = this.props.tabOnChanged;

        tabOnChanged(e.target.value);
    }
    
    render() {
        let { playlist, data, currentTrackIndex, currentTab, favorites, starOnClick, trackOnClick, trackListOnScrolled, fetching } = this.props,
